...
00  Confirm CAVE access and inspect the Pyr.ai environment
 ...
 │
 └── 04  Download and inspect the nuclei table
      └── 05  Curate vascular roots and build a screened nonvascular population
           └── 06  Explore the screened population and develop 3D visualization approaches
                ├── 07  Visualize screened roots and selected meshes with Plotly
                └── 07  Visualize nuclei centroids and selected meshes with VTK
```

Notebook 06 is exploratory and documents the analysis and visualization development that led to the more polished Notebook 07 viewers. The two Notebook 07 implementations provide complementary interactive views using Plotly and VTK.
